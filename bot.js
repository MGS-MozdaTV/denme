...
client.on('ready', ()=>{
client.channels.cache.get('699985693790699580').join()
})
          ...
          try {
            if (!msg.member.hasPermission("MANAGE_GUILD")) {
                  msg.delete();
                    ...
                    return msg.channel.send(`**Bu Sunucuda Küfür Etmek Yasak Lütfen Kelimlerine Dikkat Et !**`).then(nordx => nordx.delete({timeout: 5000}))
            }              
                } catch(err) {
                  console.log(err);
                }
    ...
    if (reklamengel.some(word => message.content.toLowerCase().includes(word))) {
      try {
        if (!message.member.permissions.has('KICK_MEMBERS')) {
          ...
          return message.reply('**Hey Dur! Ben Hala Bu Sunucudayım Ben Varken Reklam Yapamazsın!!**').then(nordx => nordx.delete({timeout: 5000}))
...
client.on('guildMemberAdd', async member => {
    ...
    .setTitle(`VorteX Otorol`)
    .setDescription(
	`
	
	
	**Rol Verilen ** ${member.user} 
	
	**Verilen Rol**, <@&${rol}> 
	`)
    .setColor("")
	.setThumbnail("https://cdn.discordapp.com/attachments/836639938870902788/844610507200659486/4c5598ecf9869c63da73aacb1ecf2243.jpg")
...
client.on("guildMemberAdd", member => {
      ...
      if(üs) {
        üyesayısı = üyesayısı.replace(/([0-9])/g, d => {
          ...
          '0': `0`,
            ...
            '8': `8`,
            '9': `9`}[d];})}
      const kanal = member.guild.channels.cache.find(r => r.id === "805525265219452969");//mesaj atılcak kanal id
  ...
  <a:uzii:783772125365665854> <@`+member.id+`> **Sunucumuza Hoş Geldin !** 
  
  
  <a:uzayy:783775812867981322> **Seninle Birlikte `+üyesayısı+`  Kişiye Ulaştık !**
  

  <a:hhi:783775684727668766> **Sunucumuzun Kurallarına Uymayı Unutma, Kurallarımızı Okumanı Tavsiye Ederiz.**
  
  
  <a:elmasii:847232975552380928> **İçeride Keyifli Vakitler Geçirmeni Dileriz.**
`)
  .setImage('https://cdn.discordapp.com/attachments/780520153749127171/825443222527541248/standard.gif')
  kanal.send(embed) 
});
...
.setFooter(`Sunucu: ${role.guild.name} -`, role.guild.iconURL)
...
client.on("guildMemberAdd", async member => {
    ...
    client.channels.cache.get(SKanal).send(` <a:gir:847141391133966436> ${member} **adlı kullaanıcı sunucuya katıldı**  ${hedef} **kişi olmamıza** ${hedef2} **kişi kaldı**`)
})
client.on("guildMemberRemove", async member => {
    ...
    client.channels.cache.get(SKanal).send(`<a:bb:847141373072506880> ${member} **adlı kullanıcı sunucudan ayrıldı**  ${hedef} **kişi olmamıza** ${hedef2} **kişi kaldı**`)
})
