...
exports.run = async (client, message, args) => {
    ...
    if (gn.getMonth() == 0 && gn.getDate() == 1) {
        ...
        var t = sayac(son);
        message.channel.send(new Discord.MessageEmbed().setDescription(`▬▬▬▬▬▬[<a:emo:847173080937005116> **Yılbaşı Sayacı** <a:emo:847173080937005116>]▬▬▬▬▬▬\n\n**Kalan Gün:** ${t.gun}  \n **Kalan Saat:** ${t.saat}  \n **Kalan Dakika:** ${t.dakika}  \n **Kalan Saniye:** ${t.saniye} `))
        if(t.total<=0){
